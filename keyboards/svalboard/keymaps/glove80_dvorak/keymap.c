...
uint16_t qmk_settings_get_quick_tap_term_user(uint16_t keycode, keyrecord_t *record, uint16_t quick_tap_term) {
  ...
  switch (keycode) {
    ...
    case TH_SYS:
    case KVM_SYS:
      return THUMB_LT_QUICK_TAP_TERM;
    default:
 ...
 *   on the home-row mods, with a shorter override on every thumb layer-tap
 *   above so their layers engage quickly after a tap
 */
static void sync_runtime_qmk_settings(void) {
  ...
  set_qmk_setting_u16(QSID_QUICK_TAP_TERM, GLOBAL_QUICK_TAP_TERM);
...
const uint16_t PROGMEM keymaps[DYNAMIC_KEYMAP_LAYER_COUNT][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        /*R3*/ HM_N            , KC_R           , KC_BSLS         , KC_V            , KC_B          , KC_NO ,
        /*R4*/ HM_S            , KC_L           , KC_SLSH         , KC_Z            , QK_REPEAT_KEY , KC_NO ,
        ...
        /*LT*/ TH_MBO          , TH_SYM          , KVM_SYS             , TH_SYS            , LCAG(KC_NO)     , SV_CAPS_WORD
    ),
    ...
    [SYM] = LAYOUT(
        /*     Center            North             East              South             West              Double */
        /*R1*/ QUES            , PERC            , RPRN            , EXLM             , LPRN            , KC_NO ,
        /*R2*/ DQUO            , CIRC            , KC_RBRC         , AT               , KC_LBRC         , KC_NO ,
        /*R3*/ COLN            , AMPR            , RCBR            , HASH             , LCBR            , KC_NO ,
        /*R4*/ UNDS            , TILD            , KC_NO           , DLR              , KC_SCLN         , KC_NO ,
        ...
        /*     Down            Pad      Up       Nail     Knuckle  DoubleDown */
        /*RT*/ KC_BSLS       , KC_SLSH    , GTGT   , LTGT   , PIPE   , KC_NO,
    ...
    [FUNC] = LAYOUT(
        ...
        /*L2*/ KC_F2           , KC_F10           , KC_F14          , KC_F6           , KC_F22           , KC_NO ,
        /*L3*/ KC_F3           , KC_F11           , KC_F15          , KC_F7           , KC_F23           , KC_NO ,
        /*L4*/ KC_F4           , KC_F12           , KC_F20          , KC_F8           , KC_F24           , KC_NO ,

        /*     Down            Pad      Up       Nail     Knuckle  DoubleDown */
        /*RT*/ KC_TRNS       , KC_TRNS, KC_TRNS, SV_LOCK_FUNC, KC_TRNS, KC_TRNS ,
        /*LT*/ KC_VOLD       , KC_MUTE, KC_VOLU, KC_MNXT, KC_MPLY, KC_MPRV
    ),
